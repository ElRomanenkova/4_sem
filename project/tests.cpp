...
void Testcase_memfail() {
    errno = 0;
    RB_Node * fail_node = new RB_Node(42);
    UNITTEST(errno, ==, ENOMEM);
    UNITTEST(fail_node, ==, NULL);

    errno = 0;
    RB_Tree * fail_tree = new RB_Tree;
    UNITTEST(errno, ==, ENOMEM);
    UNITTEST(fail_tree, ==, NULL);

    errno = 0;
    fail_tree = new RB_Tree;
    UNITTEST(errno, ==, ENOMEM);
    UNITTEST(fail_tree, ==, NULL);

    RB_Node * node1 = new RB_Node(25);
    UNITTEST(node1, !=, NULL);
    ...
    for (int i = 0; i < 3; i++) {
        RB_Node * node = new RB_Node(i);
        UNITTEST(node, !=, NULL);
        UNITTEST(node->key, ==, i);

        int ret_insert = tree->RB_insert(node);
...
//{
//    RB_Tree * tree = new RB_Tree;
//    int fail_dump = tree->tree_dump(nullptr);
//    UNITTEST(fail_dump, <, 0);
//////////////////////////////////////////////////////////////////////////////////
//    tree = new RB_Tree;
//    UNITTEST(tree, !=, NULL);
//
//    FILE* out_empty = fopen("dump_empty.txt", "w");
//    if (out_empty == nullptr)
//    {
//        perror("Open out_empty file error\n");
//        exit(-1);
//    }
//    int dump_empty_tree = tree->tree_dump(out_empty);
//    UNITTEST(dump_empty_tree, ==, 0);
//    fclose(out_empty);
//
//////////////////////////////////////////////////////////////////////////////////
//    FILE* out_tree = fopen("dump_tree.txt", "w");
//    if (out_tree == nullptr)
//    {
...
//    for (int i = 0; i < 3; i++)
//    {
//        RB_Node * new_node = new RB_Node(arr_nums[i]);
//
//        ret_dump_insert = tree->RB_insert(new_node);
//        UNITTEST(ret_dump_insert, ==, 0);
//    }
//
//    int dump_tree = tree->tree_dump(out_tree);
...
//    }
//
//    FILE* nothing = fopen("nothing.txt", "w");
//    if (nothing == NULL)
//    {
...
//    tree->root = NULL;
//    int dump_nothing_tree = tree->tree_dump(nothing);
//    UNITTEST(dump_nothing_tree, ==, BAD_TREE_CONDITION);
//    tree->root = save_root;
//
//    tree->num_nodes = 2;
//    dump_nothing_tree = tree->tree_dump(nothing);
//    UNITTEST(dump_nothing_tree, ==, BAD_TREE_CONDITION);
//    tree->num_nodes = 3;
//
//    tree->num_nodes = 1;
...
//    tree->num_nodes = 3;
//
//    tree->root->right_ch->right_ch = nullptr;
//    dump_nothing_tree = tree->tree_dump(nothing);
//    UNITTEST(dump_nothing_tree, ==, BAD_TREE_CONDITION);
//    tree->root->right_ch->right_ch = tree->nil;
//
//    tree->root->right_ch->left_ch = nullptr;
//    dump_nothing_tree = tree->tree_dump(nothing);
//    UNITTEST(dump_nothing_tree, ==, BAD_TREE_CONDITION);
//    tree->root->right_ch->left_ch = tree->nil;
//
//    tree->root->right_ch->parent = nullptr;
//    dump_nothing_tree = tree->tree_dump(nothing);
//    UNITTEST(dump_nothing_tree, ==, BAD_TREE_CONDITION);
